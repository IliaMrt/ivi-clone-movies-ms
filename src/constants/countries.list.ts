export const CountriesList = [
  ...
  {shortName: 'ac', nameRu: 'Антигуа и Барбуда', nameEn: 'Antigua and Barbuda' },
  ...
  {shortName: 'aq', nameRu: 'Американское Самоа', nameEn: 'American Samoa' },
  ...
  {shortName: 'bk', nameRu: 'Босния и Герцеговина', nameEn: 'Bosnia and Herzegovina' },
  ...
  {shortName: 'iv', nameRu: 'Берег Слоновой Кости', nameEn: 'Ivory Coast' },
  ...
  {shortName: 'kt', nameRu: 'Остров Рождества', nameEn: 'Christmas Island' },
  ...
  {shortName: 'dr', nameRu: 'Доминиканская Республика', nameEn: 'Dominican Republic' },
  ...
  {shortName: 'fk', nameRu: 'Фолклендские острова', nameEn: 'Falkland Islands' },
  ...
  {shortName: 'fg', nameRu: 'Французская Гвиана', nameEn: 'French Guiana' },
  ...
  {shortName: 'ek', nameRu: 'Экваториальная Гвинея', nameEn: 'Equatorial Guinea' },
  ...
  {shortName: 'sc', nameRu: 'Сент-Китс и Невис', nameEn: 'St Kitts and Nevis' },
  ...
  {shortName: 'cj', nameRu: 'Каймановы острова', nameEn: 'Cayman Islands' },
  ...
  {shortName: 'rm', nameRu: 'Маршалловы острова', nameEn: 'Marshall Islands' },
  {shortName: 'mk', nameRu: 'Северная Македония', nameEn: 'North Macedonia' },
  ...
  {shortName: 'fp', nameRu: 'Французская Полинезия', nameEn: 'French Polynesia' },
  {shortName: 'pp', nameRu: 'Папуа-Новая Гвинея', nameEn: 'Papua New Guinea' },
  ...
  {shortName: 'sb', nameRu: 'Сен-Пьер и Микелон', nameEn: 'Saint Pierre and Miquelon' },
  {shortName: 'pc', nameRu: 'Острова Питкэрн', nameEn: 'Pitcairn Islands' },
  ...
  {shortName: 'bp', nameRu: 'Соломоновы острова', nameEn: 'Solomon Islands' },
  ...
  {shortName: 'sh', nameRu: 'Остров Святой Елены', nameEn: 'Saint Helena' },
  {shortName: 'si', nameRu: 'Словения', nameEn: 'Slovenia' },
  {shortName: 'sv', nameRu: 'Шпицберген и Ян-Майен', nameEn: 'Svalbard and Jan Mayen' },
  ...
  {shortName: 'tp', nameRu: 'Сан-Томе и Принсипи', nameEn: 'São Tomé and Príncipe' },
  ...
  {shortName: 'td', nameRu: 'Тринидад и Тобаго', nameEn: 'Trinidad and Tobago' },
  ...
  {shortName: 'vq', nameRu: 'Виргинские острова США', nameEn: 'U.S. Virgin Islands' },
  {shortName: 'vm', nameRu: 'Вьетнам', nameEn: 'Vietnam' },
  {shortName: 'nh', nameRu: 'Вануату', nameEn: 'Vanuatu' },
  {shortName: 'wf', nameRu: 'Уоллис и Футуна', nameEn: 'Wallis and Futuna' },
